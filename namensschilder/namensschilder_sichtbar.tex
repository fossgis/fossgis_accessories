...
\put(5mm,30mm){
  ...
  % prüfen ob die Seitenränder eingehalten werden

        \begin{minipage}[c][30mm]{90mm}
          \centering{\fontsize{36}{45}\textbf{#1}}
          \vskip 0mm
          \centering{ #4}
        \end{minipage}  
...
\put(5mm,47mm){\parbox{93mm}{\raggedleft \footnotesize
